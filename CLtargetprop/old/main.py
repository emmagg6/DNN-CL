...
Adaptation for single-trial Continual Learning by emmagg6.
...
def main(**kwargs):
    ...
    print("ff1 type: " + kwargs["forward_function_1"])
    print("ff1 act" + kwargs["forward_function_1_activation"])
    print("ff1 init" + kwargs["forward_function_1_init"])
    print("ff2 type: " + kwargs["forward_function_2"])
    print("ff2 act" + kwargs["forward_function_2_activation"])
    print("ff2 init" + kwargs["forward_function_2_init"])
    ...
    if kwargs["dataset"] == "MNIST":
        num_classes = 10
        print("label_augmentation: ", kwargs["label_augmentation"])
        print("out_dim: ", kwargs["out_dim"])
        print("test: ", kwargs["test"])
    ...
    if kwargs["algorithm"] in BP_LIST:
        ...
        model.train(train_loader, valid_loader, kwargs["epochs"], kwargs["learning_rate"],
                    ...
                    kwargs["log"], kwargs["save"], {"loss_feedback": kwargs["loss_feedback"], "epochs_backward": kwargs["epochs_backward"]},
                    save_ckpts='checkpoints/tp/ckpt-FWDTP-m-f.pth', new_ckpt='checkpoints/tp/FWDTP-m-f-m.pth', train_ckpts='checkpoints/tp/training-FWDTP-m-f-m.pth')
