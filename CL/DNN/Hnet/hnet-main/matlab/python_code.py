...
def dataset(is_trn, n_per_class):
    ...
    data = scipy.sparse.load_npz('/Users/emmagraham/Documents/GitHub/DNN-CL/CL/DNN/Hnet/hnet-main/datasets/img_captchas/mnist_784.npz') # (emmagg6) comment this out and uncomment previous for your code
